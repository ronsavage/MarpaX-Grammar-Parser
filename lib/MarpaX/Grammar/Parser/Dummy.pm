...
C<MarpaX::Grammar::Parser::Dummy> - A dummy plugin for MarpaX::Grammar::Parser
...
This module is a dummy plugin for L<MarpaX::Grammar::Parser>. It is used by L<MarpaX::Grammar::Parser>
