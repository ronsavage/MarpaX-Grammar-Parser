...
In other words, if you patch sub run():

From this (which returns the tree but prints nothing):
...
And redirected the output, you would get data/stringparser.treedumper.
...
The Marpa Guide is L<here|http://marpa-guide.github.io/>.
